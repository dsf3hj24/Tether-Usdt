# Contributing to Tether(USDT) Core

Tether(USDT) Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/Tether(USDT)/Tether(USDT)/labels/help%20wanted)
* [Projects](https://github.com/Tether(USDT)/Tether(USDT)/projects)
* [Tether(USDT)dev on reddit](https://www.reddit.com/r/Tether(USDT)dev/)

## Branch Strategy

Tether(USDT) Core's default branch is intentionally a stable release, so that anyone
...
Tether(USDT) Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Tether(USDT) Core
releases will automatically benefit from these.

When refactoring Tether(USDT)-specific code, please keep refactoring requests short,
...
The following applies to code changes to Tether(USDT) Core, and is not to be
confused with overall Tether(USDT) Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Tether(USDT) Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Tether(USDT); meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Tether(USDT)
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Tether(USDT) consensus, it must have been
